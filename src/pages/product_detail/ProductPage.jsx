...
import {
  ...
  getListBrand,
  getListCategory, getProductById
} from "../../actions";
import {
  addItemToCart,
  addToCart,
...
const Product_Page3 = (props) => {
  ...
  let newProduct1 = Object.assign({}, findItem, { quantity: 1 });

  useEffect(() => {
  
    // for insert data into detailproduct in redux
    props.DetailedProducts(newProduct1);
  }, [findItem]);
  ...
  const increaseQty = (index, product, quantity) => {
    console.log(index, quantity, product);
                        ...
                        <article className="gallery-wrap" >
                          <div className="img-big-wrap img-thumbnail">
                            <a
                              ...
                              href="#"
                            >
                              <img height={560} src={newProduct.image} />
                            </a>
                          </div>
                          <div className="thumbs-wrap">
                            ...
                            <a
                              data-fslightbox="mygalley"
                              data-type="image"
                              href="images/items/detail1/big2.jpg"
                              className="item-thumb"
                            >
                              <img
                                width={60}
            ...
            <span className="label-rating text-success">In stock</span>
                          ...
                          <div className="mb-3">
                            <var className="price h5 me-5">
                              {newProduct.promotionPrice} VNĐ
                            </var>
                            <del className="price-old">
                              {newProduct.unitPrice} VNĐ
                            </del>
                            {/* <span className="text-muted">/per box</span>  */}
                          </div>
                          <p>{newProduct.shortDesc}</p>
                          <dl className="row">
                            <dt className="col-3">Mã sản phẩm:</dt>
                            <dd className="col-9">{newProduct.code}</dd>
                            <dt className="col-3">Danh mục:</dt>
                            <dd className="col-9">
                              {newProduct.category?.name}
                            </dd>
                            <dt className="col-3">Thương hiệu:</dt>
                            <dd className="col-9">{newProduct.brand?.name}</dd>
                            <dt className="col-3">Số lượng còn</dt>
                            <dd className="col-9">
                              {newProduct.instock} sản phẩm
                            </dd>
                          </dl>
                          <hr />
              ...
              <select className="form-select">
                ...
                <option>Large</option>
                          ...
                          <button
                            ...
                            onClick={() => addProductToCart(newProduct)}
                          >
                            <i className="me-1 fa fa-shopping-basket" /> Thêm
                            vào giỏ
                          </button>
                          <button
                            className="btn  btn-light"
                            onClick={() => AddToWishList(newProduct)}
                          >
                ...
                <a href="#" data-bs-target="#tab_seller" data-bs-toggle="tab" className="nav-link">Seller profile</a>
                          ...
                          <div className="tab-content">
                            ...
                            >
                              <div
                                dangerouslySetInnerHTML={{
                                  __html: newProduct.specification,
                                }}
                              />
                            </article>
                            <article
                            ...
                            >
                              <div className="card-body">
                                <h5 className="card-title">Reviews
                                <button href="#" className="btn  btn-primary-light float-end" onClick={handleShow}>Viết đánh giá</button>
                                </h5> 
                                ...
                                <blockquote className="border-bottom">
                                  ...
                                  <div className="icontext">
                                    ...
                                    />
                                    <div className="text">
                                      <h6 className="mb-0">{element.user.firstName + element.user.lastName} </h6>
